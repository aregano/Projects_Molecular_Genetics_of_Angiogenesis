...
palette_Maca_Vln <- c("#606060", "#F94040", "#9E1F63", "#ACC2D9")
...
plegend <- VlnPlot(Liver, features = genes[i, 1], group.by = "Condition") +
  scale_fill_manual(values= palette_Maca_Vln, labels=c("Control", expression(italic("Dll4"^"iDEC")), expression(italic(Dll4Het)^"iDEC"), expression("DBZ")))
plegend
...
cairo_pdf("Plots/Figure_4/Suplementary/Figure_S4.4G_VlnPlot.pdf", width = 6, height = 3, family = "Arial")
p27
dev.off()

jpeg("Plots/Figure_4/Suplementary/Figure_S4.4G_VlnPlot.jpeg", width = 6, height = 3, units = 'in', res = 800)
p27
dev.off()
